...
class Migration(migrations.Migration):
    ...
    state_operations = [migrations.CreateModel(
        name='Address', fields=[('id', models.AutoField(
        ...
        name='Profile', fields=[('id', models.AutoField(
            auto_created=True, primary_key=True, serialize=False, verbose_name='ID'
        ...
        name='Letting', fields=[('id', models.AutoField(
            auto_created=True, primary_key=True, serialize=False, verbose_name='ID'
        )), ('title', models.CharField(max_length=256)), ('address', models.OneToOneField(
